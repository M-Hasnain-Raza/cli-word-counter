...
console.log(`[ ${chalk.bgBlueBright.bold(" Words: " + words.length + " ")} | ${chalk.bgGreenBright.bold(" Characters: " + characters.length + " ")} | ${chalk.bgCyanBright.bold(" Lines: " + line.length + " ")} ]`);
